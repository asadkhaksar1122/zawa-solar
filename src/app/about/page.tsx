// about.jsx - Updated with enhanced team section animations
"use client"
...
const About = () => {
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            {/* Enhanced Team Section with Beautiful Animations */}
                                ...
                                <motion.div variants={cardVariants} className="relative">
                                    ...
                                    <Card className="border-border/40 overflow-hidden h-full cursor-pointer relative bg-background/95 backdrop-blur-sm">
                                        <CardContent className="p-6 text-center">
                                            {/* Front View - Your existing content with enhanced image animation */}
                                            ...
                                            {/* Hover View - Your existing detailed information with animation */}
                                            <motion.div
